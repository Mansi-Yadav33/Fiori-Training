		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mckdemorouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mckdemorouting-display": {
								"semanticObject": "mckdemorouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mck.demo.routing",
									"url": sap.ui.require.toUrl("mck/demo/routing")
								}
							}
						}
					}
