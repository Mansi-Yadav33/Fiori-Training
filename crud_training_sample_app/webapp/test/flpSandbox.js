		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Training CRUD Sample",
									"targetURL": "#crudtrainingsampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crudtrainingsampleapp-display": {
								"semanticObject": "crudtrainingsampleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudtrainingsampleapp",
									"url": sap.ui.require.toUrl("crudtrainingsampleapp")
								}
							}
						}
					}
